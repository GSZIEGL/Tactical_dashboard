...
RUNTIME_RESET_KEYS = [
    "dims", "team_metrics", "opp_metrics", "team_debug_rows", "opp_debug_rows",
    "team_sheet_debug", "opp_sheet_debug", "team_matches", "opp_matches",
    "selected_plan_a", "selected_plan_b", "selected_split",
    "team_players", "opp_players", "warnings", "three_keys", "match_dynamics",
    "team_pdf_text", "opp_pdf_text", "team_pdf_insights", "opp_pdf_insights",
...
@media print {
  ...
  .summary-avoid-break, .summary-block, .summary-chartbox, .summary-viz-page, .summary-unit, .summary-section-wrap, .summary-chart-block { break-inside: avoid; page-break-inside: avoid; }
  .summary-chartbox iframe { margin-top:-8px !important; margin-bottom:-12px !important; }
  .viz-unit-radar .summary-chartbox { min-height: 500px !important; }
  .viz-unit-bar .summary-chartbox { min-height: 420px !important; }
  .viz-unit-map .summary-chartbox { min-height: 470px !important; }
